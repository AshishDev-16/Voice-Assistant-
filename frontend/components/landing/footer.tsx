...
export function Footer() {
  return (
    <footer className="bg-[#030712] border-t border-white/10 text-slate-400 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm">
              The AI-powered WhatsApp Business Assistant that sells for you while you sleep.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-emerald-400 transition-colors">Integrations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-emerald-400 transition-colors">Customers</Link></li>
