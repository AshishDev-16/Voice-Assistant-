...
export function HowItWorksSection() {
  ...
  return (
    <section className="py-24 bg-[#030712] text-white relative border-t border-white/5 overflow-hidden">
      {/* Ambient background blur */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-emerald-500/5 rounded-[100%] blur-[120px] pointer-events-none z-0"></div>
        ...
        <div className="grid md:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-white/5 backdrop-blur-xl border border-emerald-500/40 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(16,185,129,0.2)] relative transition-transform hover:scale-110">
