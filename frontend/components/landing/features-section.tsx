...
export function FeaturesSection() {
  ...
  return (
    <section className="py-24 bg-[#030712] relative overflow-hidden text-white">
      ...
      <div className="absolute top-0 right-[-10%] w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[150px] pointer-events-none z-0"></div>
      <div className="absolute bottom-0 left-[-10%] w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[150px] pointer-events-none z-0"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="relative p-8 rounded-3xl bg-white/5 border border-white/10 shadow-2xl hover:border-emerald-500/50 transition-colors backdrop-blur-2xl group">
