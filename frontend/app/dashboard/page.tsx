  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <div className="col-span-4 rounded-xl border border-white/10 bg-white/5 backdrop-blur-2xl p-6 shadow-xl">
          <h3 className="font-semibold text-lg mb-4 text-white">Conversation Volume</h3>
          <div className="h-[300px] w-full flex items-center justify-center border border-dashed border-white/10 rounded-lg text-zinc-400 bg-black/20 backdrop-blur-md shadow-inner">
            [Chart Area Placeholder]
          </div>
        </div>
        <div className="col-span-3 rounded-xl border border-white/10 bg-white/5 backdrop-blur-2xl p-6 shadow-xl">
          <h3 className="font-semibold text-lg mb-4 text-white">Recent AI Actions</h3>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex flex-col gap-1 border-b border-white/10 pb-3 last:border-0 last:pb-0">
                <span className="text-sm font-medium text-zinc-100">{feed.action}</span>
